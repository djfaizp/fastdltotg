...
const { formatCaption, formatMetadata } = require('./aria2'); // Import the shared formatter
        ...
        if (doc.directUrls?.[res]) {
            ...
            if (storedFileName === currentFileName) {
                ...
                try {
                    ...
                    // Use the shared caption formatter
                    const metadata = formatMetadata(doc, res);
                    const caption = formatCaption(metadata, storedFileName);
